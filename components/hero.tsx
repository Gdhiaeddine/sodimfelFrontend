...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`absolute inset-0 ${
            isArabic
              ? 'bg-gradient-to-l from-[var(--ink)] via-[var(--ink)]/70 to-transparent'
              : 'bg-gradient-to-r from-[var(--ink)] via-[var(--ink)]/70 to-transparent'
          }`}
        />
      ...
      <motion.div
        style={{ x: tfX, y: tfY }}
        className={`absolute top-1/2 hidden h-[88%] w-[58%] -translate-y-1/2 md:block ${
      ...
      <motion.div
        ...
        className={`absolute top-1/2 h-[70%] w-[90%] -translate-y-1/2 md:hidden ${
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 lg:px-10 xl:-translate-y-10 2xl:translate-y-0">
        <div className={`max-w-xl ${isArabic ? 'ml-auto text-right' : ''}`}>
          <motion.p
          ...
          <motion.h1
            ...
            style={{ letterSpacing: isArabic ? '0' : '-0.04em' }}
          >
